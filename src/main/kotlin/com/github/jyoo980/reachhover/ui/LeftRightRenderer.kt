 ...
 *
 * [mainRenderer] component is aligned to the left, [rightRenderer] component is aligned to the
 * right. This renderer uses background from [mainRenderer] component.
 */
class LeftRightRenderer<T>(
    ...
    private val spacer = JPanel().apply { border = JBUI.Borders.empty(0, 2) }
    ...
    override fun getListCellRendererComponent(
        ...
        val mainComponent =
            mainRenderer.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus)
        val rightComponent =
